...
$image_address="www.iitbhu.ac.in/rolling/upload/$table_name/image.jpeg";
$signature_address="www.iitbhu.ac.in/rolling/upload/$table_name/signature.jpeg";
...
<div id='image'><img id='applicant_image' src=".$image_address."/></div>
...
<!--code for professional experience-->
				...
				<td><label class='arrange_text'>".$rows['professional_experience_bdsmbbs_nature_work'] ."</label></td>
				...
				<td><label class='arrange_text'>".$rows['professional_experience_mdsmdmsdnb_nature_work']."</label></td>
				...
				<td><label class='arrange_text'>".$rows['professional_experience_phd_nature_work'] ."</label></td>
...
<td><label class='arrange_text'>".$rows['awards_award_date']."</label></td>
				...
				<label class='arrange_text'>".$rows['junior_resident']."</label>
				</p>
				<p><h3> b. As Senior Resident/ Post PG demonstrator/ Tutor/ SSR:</h3>
				<label class='arrange_text'>".$rows['senior_resident'] ."</label>
				</p>
				<p><h3> c. As Faculty in teaching institutions:</h3>
				<label class='arrange_text'>".$rows['faculty_teaching'] ."</label>
				</p>
				...
				<label class='arrange_text'>".$rows['pro_details_work_done'] ."</label>
				</p>
...
<td><label class='arrange_text'>".$rows['other_programme_ pages']."</label></td>
...
<img id='applicant_signature' src=".$signature_address."/>
</div>
</p>
