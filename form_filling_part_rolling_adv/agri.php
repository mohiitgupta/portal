...
//echo "agri";
 ...
 $form_content="
	<div class='general_information'>
		<br/>
		<br/>
		<label id='main_title'>APPLICATION FORM FOR FACULTY OF AGRICULTURE</label><br/><br/><br/>
		<div class='main_title_info'>
			<div id='image'></div>
				...
				<p class='arrange_field'>10. spouse Name:<input type='text' class='arrange_text' name='spouse_name' id='spouse_name' 					value=".h($_POST['spouse_name'])."></p>				
				...
				<th columnspan='1'>Rank at the Board or University Examination</th>
				</tr>
				...
				<tr><td>M.Phil.*</td>
				<td><input type='text' name='mphil_board'     value=".  h($_POST['mphil_board']) ."></td>
				<td><input type='text' name='mphil_year_passing'     value=". h($_POST['mphil_year_passing']) ."></td>
				<td><input type='text' name='mphil_subjects'     value=". h($_POST['mphil_subjects']) ."></td>
				<td><input type='text' name='mphil_marks'     value=". h($_POST['mphil_marks']) ."></td>
				<td><input type='text' name='mphil_distinction'     value=".  h($_POST['mphil_distinction']) ."></td></tr>
				...
				<tr><td>CSIR/UGC NET or Equivalent*</td>
				<td><input type='text' name='net_board'     value=".  h($_POST['net_board']) ."></td>
				<td><input type='text' name='net_year_passing'     value=". h($_POST['net_year_passing']) ."></td>
				<td><input type='text' name='net_subjects'     value=". h($_POST['net_subjects']) ."></td>
				<td><input type='text' name='net_marks'     value=". h($_POST['net_marks']) ."></td>
				<td><input type='text' name='net_distinction'     value=".  h($_POST['net_distinction']) ."></td></tr>
				...
				<p>[* Indicate Name of the Degree]</p>
				
				<p><h3>Title of Dissertation/Thesis:</h3></p>
				
				<p>a.) P.G. :</p>
				<textarea name='title_pg' id='title_pg' rows='5' cols='80' />".  h($_POST['title_pg']) ."</textarea>
				<p>b.) M.Phil. :</p>
				<textarea name='title_mphil' id='title_mphil' rows='5' cols='80' />".  h($_POST['title_mphil']) ."</textarea>
				<p>c.) Ph.D. :</p>
				<textarea name='title_phd' id='title_phd' rows='5' cols='80' />".  h($_POST['title_phd']) ."</textarea>
