	...
	<div class='general_information'>
		...
		<div class='main_title_info'>
			<div id='image'></div>
				...
				<p class='arrange_field' >Position applied for:<input type='text' name='position_applied' class='arrange_text' 					id='position_applied' value=".$positionApplied."></p>
				<p class='arrange_field'>Name of Department:<label class='arrange_text'>".$departmentName."</label></p>
				<p class='arrange_field'>Name of the candidate:<label class='arrange_text'> ".$name."</label></p>
				<p class='arrange_field'>Father's name:<input type='text' class='arrange_text' name='fathers_name' id='fathers_name' 					value=".h($_POST['fathers_name'])."></p>
				<p id='alerts'> ". messageAlert('fathers_name')."</p>
				<p class='arrange_field'>Mother's Name:<input type='text' class='arrange_text' name='mothers_name' id='mothers_name' 					value=".h($_POST['mothers_name'])."></p>
				<p id='alerts'> ". messageAlert('mothers_name')."</p>
				<p>Address:<br/></p>
				<p class='arrange_field'>Correspondence:<textarea name='correspondence' class='arrange_text' id='correspondence' 					rows='5' cols='40' /> ". h($_POST['correspondence'])." </textarea></p><br/><br/><br/><br/>
				<p class='arrange_field'>Permanent:<textarea name='permanent' id='permanent' class='arrange_text' rows='5' cols='40' 					> ". h($_POST['permanent'])."</textarea></p><br/><br/><br/><br/>
				<p id='alerts'>".messageAlert('permanent')." </p>
				<p class='arrange_field'>Mobile Number:<input type='text' name='mobile_number' class='arrange_text' 					id='mobile_number'value=".h($_POST['mobile_number'])."></p>
				...
				<p class='arrange_field'>Nationality:<label class='arrange_text'> ". $country."</label></p>
				...
				<tr><td>B.A./B.Sc. ( for non medical graduates )</td>
				...
				<tr><td>BAMS. 3rd Prof 4th Yr.</td>
				<td><input type='text' name='bds3_4_school' size='10px' value=".  h($_POST['bds3_4_school']) ."></td>
				<td><input type='text' name='bds3_4_board' size='10px' value=".  h($_POST['bds3_4_board']) ."></td>
				<td><input type='text' name='bds3_4_year_admission' size='10px' value=".  h($_POST['bds3_4_year_admission']) ."></td>
				<td><input type='text' name='bds3_4_year_passing' size='10px' value=".  h($_POST['bds3_4_year_passing']) ."></td>
				<td><input type='text' name='bds3_4_percentage' size='10px' value=".  h($_POST['bds3_4_percentage']) ."></td>
				<td><input type='text' name='bds3_4_extra_attempts' size='10px' value=". h($_POST['bds3_4_extra_attempts']) ."></td>
				<td><input type='text' name='bds3_4_distinction' size='10px' value=".  h($_POST['bds3_4_distinction']) ."></td>
				<tr><td>BAMS. 3rd Prof 5th Yr.</td>
				<td><input type='text' name='bds3_5_school' size='10px' value=".  h($_POST['bds3_5_school']) ."></td>
				<td><input type='text' name='bds3_5_board' size='10px' value=".  h($_POST['bds3_5_board']) ."></td>
				<td><input type='text' name='bds3_5_year_admission' size='10px' value=".  h($_POST['bds3_5_year_admission']) ."></td>
				<td><input type='text' name='bds3_5_year_passing' size='10px' value=".  h($_POST['bds3_5_year_passing']) ."></td>
				<td><input type='text' name='bds3_5_percentage' size='10px' value=".  h($_POST['bds3_5_percentage']) ."></td>
				<td><input type='text' name='bds3_5_extra_attempts' size='10px' value=". h($_POST['bds3_5_extra_attempts']) ."></td>
				<td><input type='text' name='bds3_5_distinction' size='10px' value=".  h($_POST['bds3_5_distinction']) ."></td>
				<tr><td>Aggregate of BAMS.</td>
				...
				<td><input type='text' name='aggregate_percentage' size='10px' value=".  h($_POST['aggregate_percentage']) ."></td>
				
				<td colspan='1'>Total:<input type='text' name='aggregate_total_extra_attempts' size='35px' value=".  h($_POST['aggregate_total_extra_attempts']) ."><br/>
				
				
				<td colspan='1'>Total No of Distinctions:<input type='text' name='aggregate_total_distinctions' size='35px' value=".  h($_POST['aggregate_total_distinctions']) ."><br/>
				
				<tr><td>Internship/House Job</td>
				...
				<p><h3>The title/s of dissertation/s at PG examinations may be nored below:</h3></p>
				...
				<p><h3> Registration Details: only for medical graduates:</h3>
				<textarea name='Medical Council' id='medical_council' rows='5' cols='80' />".  h($_POST['medical_council']) ."</textarea>
				<textarea name='Registration No.' id='registration_no' rows='5' cols='80' />".  h($_POST['registration_no']) ."</textarea>
				<textarea name='Dated' id='dated' rows='5' cols='80' />".  h($_POST['dated']) ."</textarea>
				</p>

				<!--code for professional experience-->

				<p><h3>Professional Experience Post BAMS experience, Post MD(Ay.)/MS(Ay.)/Ph.D. experience respectively</h3></p>
				...
				<tr>
				<td><input type='text' name='professional_position' size='6px' value=". h($_POST['professional_position']) ."></td>
				<td><input type='text' name='professional_department' size='6px' value=".  h($_POST['professional_department']) ."></td>
				<td><input type='text' name='professional_institution' size='6px' value=".  h($_POST['professional_institution']) ."></td>
				<td><input type='text' name='professional_from' size='6px' value=".  h($_POST['professional_from']) ."></td>
				<td><input type='text' name='professional_to' size='6px' value=".  h($_POST['professional_to']) ."></td>
				<td><input type='text' name='professional_nature_work' size='6px' value=".  h($_POST['professional_nature_work']) ."></td>
				<td><input type='text' name='professional_contractual' size='6px' value=".h($_POST['professional_contractual']) ."></td>
				<td><input type='text' name='professional_salary' size='6px' value=".h($_POST['professional_salary']) ."></td>
				</tr>
				</table>
				...
				<p><h3>Teaching Experience in years in concerned subject (details to be given only for CCIM recognized teaching institutions)</h3></p>
				<p><h3> a. a.	As Junior Resident / Post MBBS Tutor/ Demonstrator:</h3>
				<textarea name='junior resident' id='junior_resident' rows='5' cols='80' />".  h($_POST['junior_resident']) ."</textarea>
				</p>
				<p><h3> b. b.	As Senior Resident/ Post PG demonstrator/Tutor/SSR :</h3>
				<textarea name='senior resident' id='senior_resident' rows='5' cols='80' />".  h($_POST['senior_resident']) ."</textarea>
				</p>
				<p><h3> c. As Faculty in teaching institutions:</h3>
				<textarea name='faculty teaching' id='faculty_teaching' rows='5' cols='80' />".  h($_POST['faculty_teaching']) ."</textarea>
				</p>
				<p><h3> Details of Work done so far (patient care experience/ Lab work/ professional work) and significance of the professional contribution[Maximum 1000 words]. You may bring summary of your log book/thesis if any, relevant to the subject at time of interaction with FAC-1)</h3>
				<textarea name='details work done' id='details_work_done' rows='5' cols='80' />".  h($_POST['details_work_done']) ."</textarea>
				</p>
				<!--RESEARCH PART-->
				...
				<tr>
				<td><input type='text' name='peer_author' size='10px' value=".  h($_POST['peer_author']) ."></td>
				<td><input type='text' name='peer_year' size='10px' value=".  h($_POST['peer_year']) ."></td>
				<td><input type='text' name='peer_journal' size='10px' value=".  h($_POST['peer_journal']) ."></td>
				<td><input type='text' name='peer_vol' size='10px' value=".  h($_POST['peer_vol']) ."></td>
				<td><input type='text' name='peer_pages' size='10px' value=".  h($_POST['peer_pages']) ."></td>
				<td><input type='text' name='peer_issn' size='10px' value=".  h($_POST['peer_issn']) ."></td>
				</tr>
				</table>
				...
				<tr>
				<td><input type='text' name='authored_author' size='10px' value=".  h($_POST['authored_author']) ."></td>
				<td><input type='text' name='authored_title' size='10px' value=".  h($_POST['authored_title']) ."></td>
				<td><input type='text' name='authored_editor' size='10px' value=".  h($_POST['authored_editor']) ."></td>
				<td><input type='text' name='authored_publisher' size='10px' value=".  h($_POST['authored_publisher']) ."></td>
				<td><input type='text' name='authored_pages' size='10px' value=". h($_POST['authored_pages']) ."></td>
				<td><input type='text' name='authored_issn' size='10px' value=".  h($_POST['authored_issn']) ."></td>
				</tr>
				</table>
				...
				<tr>
				<td><input type='text' name='conference_name' size='10px' value=". h($_POST['conference_name']) ."></td>
				<td><input type='text' name='conference_category' size='10px' value=".  h($_POST['conference_category'])."></td>
				<td><input type='text' name='conference_date' size='10px' value=".  h($_POST['conference_date']) ."></td>
				<td><input type='text' name='conference_venue' size='10px' value=".  h($_POST['conference_venue']) ."></td>
				<td><input type='text' name='conference_pages' size='10px' value=". h($_POST['conference_pages']) ."></td>
				<td><input type='text' name='conference_presentation' size='10px' value=". h($_POST['conference_presentation']) ."></td>
				</tr>
				</table>				
				...
				<tr>
				<td><input type='text' name='programme_name_event' size='10px' value=". h($_POST['programme_name_event']) ."></td>
				<td><input type='text' name='programme_category' size='10px' value=".  h($_POST['programme_category']) ."></td>
				<td><input type='text' name='programme_date' size='10px' value=". h($_POST['programme_date']) ."></td>
				<td><input type='text' name='programme_venue' size='10px' value=".  h($_POST['programme_venue']) ."></td>
				<td><input type='text' name='programme_pages' size='10px' value=".  h($_POST['programme_pages']) ."></td>
				<td><input type='text' name='programme_role' size='10px' value=".  h($_POST['programme_role']) ."></td>
				</tr>
				</table>
				...
				<tr>
				<td><input type='text' name='projects_title' size='10px' value=".  h($_POST['projects_title']) ."></td>
				<td><input type='text' name='projects_total' size='10px' value=". h($_POST['projects_total']) ."></td>
				<td><input type='text' name='projects_funding' size='10px' value=".  h($_POST['projects_funding']) ."></td>
				<td><input type='text' name='projects_duration' size='10px' value=".  h($_POST['projects_duration']) ."></td>
				<td><input type='text' name='projects_current_status' size='10px' value=".  h($_POST['projects_current_status']) ."></td>
				</tr>
				</table>
...
<p><h3>d. Technology Transfer and Patents (granted), if any</h3>
				...
				<tr>
				<td><input type='text' name='editor_name' size='10px' value=".  h($_POST['editor_name']) ."></td>
				<td><input type='text' name='editor_publisher' size='10px' value=".  h($_POST['editor_publisher']) ."></td>
				<td><input type='text' name='editor_member' size='10px' value=".  h($_POST['editor_member']) ."></td>
				<td><input type='text' name='editor_duration' size='10px' value=".  h($_POST['editor_duration']) ."></td>
				</tr>
				</table>
				...
				<p><h3>	M.Phil./Ph.D./MD(Ay.)/MS(Ay.)/P.G. Diploma thesis  supervised during the last 12 years</h3></p>
				...
				<tr>
				<td><input type='text' name='supervised_title' size='10px' value=".  h($_POST['supervised_title']) ."></td>
				<td><input type='text' name='supervised_name' size='10px' value=".  h($_POST['supervised_name']) ."></td>
				<td><input type='text' name='supervised_award' size='10px' value=".  h($_POST['supervised_award']) ."></td>
				<td><input type='text' name='supervised_supervisor' size='10px' value=".  h($_POST['supervised_supervisor']) ."></td>
				</tr>
				</table>
				...
				<tr>
				<td><input type='text' name='referees_name' size='10px' value=". h($_POST['referees_name']) ."></td>
				<td><input type='text' name='referees_address' size='10px' value=".h($_POST['referees_address']) ."></td>
				<td><input type='text' name='referees_relationship' size='10px' value=". h($_POST['referees_relationship']) ."></td>
				<td><input type='text' name='referees_email' size='10px' value=". h($_POST['referees_email']) ."></td>
				<td><input type='text' name='referees_telephone' size='10px' value=". h($_POST['referees_telephone']) ."></td>
				</tr>
				</table>
	...
	<div id='next_previous'>
		<input type='submit' name='science_submit' id='science_submit' value='submit'/>
	</div>";
