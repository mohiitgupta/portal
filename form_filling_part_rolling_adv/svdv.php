...
//echo "svdv";
 ...
 $form_content="
	<div class='general_information'>
		<br/>
		<br/>
		<label id='main_title'>APPLICATION FORM FOR FACULTY OF ENVIRONMENTAL SCIENCE</label><br/><br/><br/>
		<div class='main_title_info'>
			<div id='image'></div>
				...
				<tr><td>Praveshika/High School(10th)</td>
				...
				<td rowspan='5'></td></tr>
				<tr><td>Madhyama/Intermediate(12th)</td>
				...
				<tr><td>Under-Graduate/Shastri *</td>
				...
				<tr><td>Post-Graduate*/Acharaya  *</td>
				...
				<tr rowspan='3'><td>Ph. D./ Vidhyavaridhi/ Chakravarti</td>
				...
				<p><h3>If a project was undertaken at PG and/or M.Phil. level, title/s of the dissertation/s may be noted below </h3>
				<textarea name='project' id='project' rows='5' cols='80' />".  h($_POST['project']) ."</textarea>
				</p>
...
<p>Attach pdf files of your 5 best research Publications</p>
				...
				<p><h3>b. b.	List your research (original and reviews) publications in (A) ISSH (B) ISBN No. or (C) an established Research Journal from latest to oldest in last 12 years  (Do not include Abstracts/Conference proceedings or other non-peer-reviewed publications)</h3></p>
				...
				<p><h3>a. a.	List of International and National Conference/Natural Language Process or other relevant Workshop (other than Orientation and Refresher courses) attended in last 12 years</h3></p>
   ...
   <!--d. d.	List participation in Sashtrartha/Vedapath/Pravachan  any -->

<p><h3>d. d.	List participation in Sashtrartha/Vedapath/Pravachan </h3>
				...
				<p><h3>f. f.	M.Phil./Ph.D.  thesis  supervised during the last 12 years</h3></p>
