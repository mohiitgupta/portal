<?php
 ...
 $form_content="
	<div class='general_information'>
		<br/>
		<br/>
		<label id='main_title'>APPLICATION FORM FOR FACULTY OF Visual Arts</label><br/><br/><br/>
...
<p><h3>d. Technology Transfer and Patents (granted), if any</h3>
	...
	<div id='next_previous'>
		<input type='submit' name='visual_arts_submit' id='visual_arts_submit' value='submit'/>
	</div>";
?>
