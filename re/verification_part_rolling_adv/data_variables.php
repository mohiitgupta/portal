...
if($departmentName=='Faculty Of Dental Science' || $departmentName=='Faculty Of Medicine'  || $departmentName=='Faculty Of Ayurveda')
{
...
if($departmentName=='Faculty Of Medicine'  || $departmentName=='Faculty Of Ayurveda')
{
$dmmchSchool=$_POST['dmmch_school'];
$dmmchBoard=$_POST['dmmch_board'];
$dmmchYearAdmission=$_POST['dmmch_year_admission'];
$dmmchYearPassing=$_POST['dmmch_year_passing'];
$dmmchPercentage=$_POST['dmmch_percentage'];
$dmmchExtraAttempts=$_POST['dmmch_extra_attempts'];
$dmmchDistinction=$_POST['dmmch_distinction'];
