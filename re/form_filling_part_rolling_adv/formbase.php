...
else if($departmentName=='Faculty Of Ayurveda')

			{
						
					
					include('../form_filling_part_rolling_adv/faculty_of_ayurveda/faculty_of_ayurveda_validation.php');
			}
			
else if($departmentName=='Faculty Of Environmental Science')

			{
						
					
					include('../form_filling_part_rolling_adv/faculty_of_environmental_science/faculty_of_environmental_science_validation.php');
			}
			else if($departmentName=='Faculty Of Agriculture')

			{
						
					
					include('../form_filling_part_rolling_adv/faculty_of_agriculture/faculty_of_agriculture_validation.php');
			}
			else if($departmentName=='Faculty Of SVDV')

			{
						
					
					include('../form_filling_part_rolling_adv/faculty_of_svdv/faculty_of_svdv_validation.php');
			}
...
$image_address="http://iitbhu.ac.in/rolling/upload/$table_name/image.jpeg";
$signature_address="http://iitbhu.ac.in/rolling/upload/$table_name/signature.jpeg";
...
#image {border:solid 2px black;height:160px;width:150px; background-image: url(<?php echo $image_address; ?>); }
#signature_box {border:solid 2px black;height:100px;width:150px; background-image: url(<?php echo $signature_address; ?>);}
		...
		if($departmentName=='Faculty Of Science')
...

			{
						...
						if(!mysql_query("select * from $table_name"))
						{
							    ...
							    include('../form_filling_part_rolling_adv/faculty_of_ayurveda/faculty_of_ayurveda.php');

							// code for pdf generatioFaculty Of ayurveda
								
						}	
						else
						{

							 include('../form_filling_part_rolling_adv/faculty_of_ayurveda/ayurveda_pdf.php');
						}
...

			{
						...
						if(!mysql_query("select * from $table_name"))
						{
							    ...
							    include('../form_filling_part_rolling_adv/faculty_of_environmental_science/faculty_of_environmental_science.php');
						...
						else
						{
							 ...
							 include('../form_filling_part_rolling_adv/faculty_of_environmental_science/environmental_science_pdf.php');
						}
...

			{
						...
						if(!mysql_query("select * from $table_name"))
						{
							    ...
							    include('../form_filling_part_rolling_adv/faculty_of_agriculture/faculty_of_agriculture.php');
						...
						else
						{
							 ...
							 include('../form_filling_part_rolling_adv/faculty_of_agriculture/agriculture_pdf.php');
						}
...

			{
						...
						if(!mysql_query("select * from $table_name"))
						{
							    ...
							    include('../form_filling_part_rolling_adv/faculty_of_svdv/faculty_of_svdv.php');
						...
						else
						{
							 ...
							 include('../form_filling_part_rolling_adv/faculty_of_svdv/svdv_pdf.php');
						}
