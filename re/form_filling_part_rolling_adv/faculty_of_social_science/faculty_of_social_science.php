<?php
 ...
 $form_content="
	<div class='general_information'>
		<br/>
		<br/>
		<label id='main_title'>APPLICATION FORM FOR FACULTY OF SOCIAL SCIENCE</label><br/><br/><br/>
...
<p><h3>d. Technology Transfer and Patents (granted), if any</h3>
	...
	<div id='next_previous'>
		<input type='submit' name='social_science_submit' id='social_science_submit' value='submit'/>
	</div>";
?>
