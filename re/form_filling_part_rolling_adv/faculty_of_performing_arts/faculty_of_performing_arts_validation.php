...
if(!$_POST['performing_arts_submit'])
   {
...
present_present_designation varchar(100) ,
	...
	research_publications_books_year varchar(100) ,
    ...
    research_publications_books_pages varchar(100) ,
							...
							research_publications_cddvd_author varchar(100) ,
	research_publications_cddvd_year varchar(100) ,
    research_publications_cddvd_title varchar(100) ,
    research_publications_cddvd_publisher varchar(100) ,
    research_publications_cddvd_catalogue varchar(50),
					...
					if($result1)
							{
								  ...
								  include("../form_filling_part_rolling_adv/faculty_of_performing_arts/enter_form.php");
