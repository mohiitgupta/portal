...
<td><label class='arrange_text'>".$rows['research_publications_books_year']."</label></td>
...
<tr>
<td><label class='arrange_text'>".$rows['research_publications_cddvd_author']."</label></td>
<td><label class='arrange_text'>".$rows['research_publications_cddvd_year']."</label></td>
<td><label class='arrange_text'>".$rows['research_publications_cddvd_title']."</label></td>
<td><label class='arrange_text'>".$rows['research_publications_cddvd_publisher']."</label></td>
<td><label class='arrange_text'>".$rows['research_publications_cddvd_catalogue']."</label></td>
</tr>
</table>
