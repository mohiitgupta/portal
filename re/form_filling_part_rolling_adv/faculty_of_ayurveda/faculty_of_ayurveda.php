<?php
 ...
 $form_content="
	<div class='general_information'>
		<br/>
		<br/>
		<label id='main_title'>APPLICATION FORM FOR Faculty OF Ayurveda</label><br/><br/><br/>
		<div class='main_title_info'>
			<div id='image'></div>
				...
				<tr rowspan='3'><td>DM / MCh </td>
				<td><input type='text' name='dmmch_school' size='10px' value=".  h($_POST['dmmch_school']) ."></td>
				<td><input type='text' name='dmmch_board' size='10px' value=".  h($_POST['dmmch_board']) ."></td>
				<td><input type='text' name='dmmch_year_admission' size='10px' value=".  h($_POST['dmmch_year_admission']) ."></td>
				<td><input type='text' name='dmmch_year_passing' size='10px' value=".  h($_POST['dmmch_year_passing']) ."></td>
				<td><input type='text' name='dmmch_percentage' size='10px' value=".  h($_POST['dmmch_percentage']) ."></td>
				<td><input type='text' name='dmmch_extra_attempts' size='10px' value=". h($_POST['dmmch_extra_attempts']) ."></td>
				<td><input type='text' name='dmmch_distinction' size='10px' value=".  h($_POST['dmmch_distinction']) ."></td>
				</td></tr>
				...
				<p><h3>a.Post BAMS experience</h3></p>
				...
				<p><h3> a. As Junior Resident/Post MBBS Tutor/ Demonstrator:</h3>
...
<p><h3>d. Technology Transfer and Patents (granted), if any</h3>
	...
	<div id='next_previous'>
		<input type='submit' name='ayurveda_submit' id='ayurveda_submit' value='submit'/>
	</div>";
